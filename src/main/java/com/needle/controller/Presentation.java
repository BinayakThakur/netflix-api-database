...
public class Presentation  extends WebMvcConfigurerAdapter {
     ...
     * searchMultiFieldQueryOr which takes, table name, n field items ,n search
     * items
    ...
    public @ResponseBody List searchDataAnd(@RequestBody SearchMapper map) {
        ...
        List data = em
                .createNativeQuery(searchUtils.searchMultiFieldQuery(map.getTable(), map.getFields(), map.getSearch()))
                .getResultList();
    ...
    public @ResponseBody List searchDataOr(@RequestBody SearchMapper map) {
        ...
        List data = em
                .createNativeQuery(
                        searchUtils.searchMultiFieldQueryOr(map.getTable(), map.getFields(), map.getSearch()))
                .getResultList();
        return data;
    }
